<%-- 
    Document   : view_panel_products
    Created on : 13-abr-2017, 23:06:07
    Author     : dasamo
--%>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                    <!-- Link trigger modal -->
                    <a href="${contextPath}/ProductController/ActViewNewProduct" data-toggle="modal" data-target="#myModalNewProduct" data-remote="false" class="btn btn-primary">
                        New product
                    </a>
