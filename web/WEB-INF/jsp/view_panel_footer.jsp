<%-- 
    Document   : view_panel_footer
    Created on : 02-nov-2016, 15:33:54
    Author     : dasamo
--%>
...
%> 
    ...
    <!-- jQuery UI 1.11.4 -->
    <script src="${contextPath}/bootstrap/js/jquery-ui.min.js"></script>
    ...
    <!-- Morris.js charts -->
    <script src="${contextPath}/plugins/raphael/2.1.0/raphael-min.js"></script>
    <script src="${contextPath}/plugins/morris/morris.min.js"></script>
    <!-- Sparkline -->
