  ...
  <body class="hold-transition skin-blue sidebar-mini fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="${contextPath}/panel/home" class="logo">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="${contextPath}/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="${contextPath}/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                            Developers
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="data:image/jpeg;base64,${foto}" class="user-image"  alt="User Image">
                  <span class="hidden-xs"><%=sesion.getAttribute("nombre").toString()%></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="data:image/jpeg;base64,${foto}" class="img-circle" alt="User Image">
                    <p>
                      <%=sesion.getAttribute("nombre").toString()%>
                      <small>Miembro desde <%=sesion.getAttribute("fechaRegistro").toString()%></small>
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
                      ...
                      <div style="text-align: center; width: 100%;">
                          <%=sesion.getAttribute("perfil").toString()%>
                      </div>
                      <!--
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-desktop"></i> <span>Dashboard</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-desktop"></i> <span>Multilevel</span>
      ...
      <input id="opmnu" value="${opmnu}" type="hidden">
      <div class="content-wrapper" >
        <!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
            ${namemenu}
            <small>${titlemenu}</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="${contextPath}/panel/home"><i class="fa fa-dashboard"></i> Home</a></li>
