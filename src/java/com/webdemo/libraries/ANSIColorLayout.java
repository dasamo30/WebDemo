...
public class ANSIColorLayout extends PatternLayout {
    ...
    public static final String DEFAULT_COLOR_ALL        = "\u001B[0;37m";
    ...
    public static final String DEFAULT_COLOR_RESET      = "\u001B[0;37m";
    public static final String DEFAULT_COLOR_STACKTRACE = "\u001B[0;37m";
    public static final String DEFAULT_COLOR            = "\u001B[0;5m";
