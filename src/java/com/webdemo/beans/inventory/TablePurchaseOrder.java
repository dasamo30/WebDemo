 ...
 * @author developer
 */
public class TablePurchaseOrder extends PurchaseOrderBean{
    ...
    public String toString() {
        return super.toString()+"TablePurchaseOrder{" + "code_suppliers=" + code_suppliers + ", name_suppliers=" + name_suppliers + ", ico_search=" + ico_search + ", ico_delete=" + ico_delete + ", ico_print=" + ico_print + '}';
    }
