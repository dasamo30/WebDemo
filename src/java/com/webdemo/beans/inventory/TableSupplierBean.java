 ...
 * @author developer
 */
public class TableSupplierBean extends SupplierBean{
     private String ico_edit;
    private String ico_delete;
    
     public TableSupplierBean() {
        super();
    }
    ...
    public String toString() {
        return super.toString()+"TableSupplierBean{" + "ico_edit=" + ico_edit + ", ico_delete=" + ico_delete + '}';
    } 
